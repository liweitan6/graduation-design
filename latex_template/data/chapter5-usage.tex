...
FuzzHub运行总览（Dashboard）是用户进入系统后的首屏，
主要用于查看测试任务的整体情况。
页面上方用统计卡片展示累计用例数、通过率、崩溃总数和平均执行耗时，
中部展示测试状态分布，
底部列出最近产生的测试用例。
这些数据主要由后端统计接口和最近用例查询接口提供。
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figure/ui_sample_manage.png}
\caption{测试用例管理界面}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.88\textwidth]{figure/ui_fault_location.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figure/ui_ai_assistance.png}
\caption{AI智能分析助手界面}
...
故障关联分析页面（Correlations）用于从整体上查看故障与算子的关系。
页面根据后端返回的故障关联数据，
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figure/ui_fault_analysis.png}
\caption{故障关联分析}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figure/ui_daikon.png}
\caption{故障临界差分对比}
\label{fig:ui_daikon}
\end{figure}
\FloatBarrier
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{figure/ui_coverage.png}
\caption{算子覆盖缺口分析界面}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.82\textwidth]{figure/ui_coverage_blind.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.80\textwidth]{figure/ui_efficiency_scatter.png}
\caption{测试效能评估界面}
...
多样性分析页面（Diversity）用于展示测试用例在二维PCA投影空间中的分布情况。
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.83\textwidth]{figure/ui_diversity.png}
\caption{测试用例多样性分布}
